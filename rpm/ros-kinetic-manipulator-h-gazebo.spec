Name:           ros-kinetic-manipulator-h-gazebo
Version:        0.3.1
Release:        0%{?dist}
Summary:        ROS manipulator_h_gazebo package
...
%description
The manipulator_h_gazebo package This package provides GAZEBO simulation
environment for ROBOTIS MANIPULATOR-H. We provides two controllers such as
